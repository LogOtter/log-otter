...
internal class ContainerItem
{
    ...
    internal ContainerItem(string id, string json, PartitionKey partitionKey, int? expiryTime, string eTag,
        bool requireETagOnNextUpdate, bool hasScheduledETagMismatch)
    {
        Id = id;
        ExpiryTime = expiryTime;
        Json = json;
