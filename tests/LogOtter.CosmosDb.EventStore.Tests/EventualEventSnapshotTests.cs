...
public class EventualEventSnapshotTests
{
    [Fact]
    public async Task InOrderEvents()
    {
        ...
        var eventualSnapshotRepository = setup.EventualSnapshotRepository;

        var message = await eventualSnapshotRepository.GetSnapshot(messageId, messageId);
