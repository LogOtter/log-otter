...
internal class NewtonsoftCustomSerializer : CosmosSerializer
{
    ...
    /// </remarks>
    internal NewtonsoftCustomSerializer(LogOtterJsonSerializationSettings jsonSerializerSettings)
    {
        _serializerSettings = jsonSerializerSettings.Settings;
    }
